...
return null;
				...
				public static Mat findEssentialMat (Mat points1, Mat points2, double focal, Point pp, int method, double prob, double threshold, Mat mask)
				{
						...
						Mat retVal = new Mat (calib3d_Calib3d_findEssentialMat_10 (points1.nativeObj, points2.nativeObj, focal, pp.x, pp.y, method, prob, threshold, mask.nativeObj));
...
return null;
				...
				public static Mat findEssentialMat (Mat points1, Mat points2, double focal, Point pp, int method, double prob, double threshold)
				{
						...
						Mat retVal = new Mat (calib3d_Calib3d_findEssentialMat_11 (points1.nativeObj, points2.nativeObj, focal, pp.x, pp.y, method, prob, threshold));
...
return null;
				...
				public static Mat findEssentialMat (Mat points1, Mat points2)
				{
						...
						Mat retVal = new Mat (calib3d_Calib3d_findEssentialMat_12 (points1.nativeObj, points2.nativeObj));
...
return -1;
		...
		// C++:  Mat findEssentialMat(Mat points1, Mat points2, double focal = 1.0, Point2d pp = Point2d(0, 0), int method = RANSAC, double prob = 0.999, double threshold = 1.0, Mat& mask = Mat())
		[DllImport("__Internal")]
		private static extern IntPtr calib3d_Calib3d_findEssentialMat_10 (IntPtr points1_nativeObj, IntPtr points2_nativeObj, double focal, double pp_x, double pp_y, int method, double prob, double threshold, IntPtr mask_nativeObj);
		
		[DllImport("__Internal")]
		private static extern IntPtr calib3d_Calib3d_findEssentialMat_11 (IntPtr points1_nativeObj, IntPtr points2_nativeObj, double focal, double pp_x, double pp_y, int method, double prob, double threshold);
		
		[DllImport("__Internal")]
		private static extern IntPtr calib3d_Calib3d_findEssentialMat_12 (IntPtr points1_nativeObj, IntPtr points2_nativeObj);
