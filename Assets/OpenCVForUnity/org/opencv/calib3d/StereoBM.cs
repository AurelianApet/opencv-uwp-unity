...
return null;
		...
		// C++:  Rect getROI1()
		[DllImport("opencvforunity")]
		private static extern void calib3d_StereoBM_getROI1_10 (IntPtr nativeObj, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 4)] double[] vals);
		...
		// C++:  Rect getROI2()
		[DllImport("opencvforunity")]
		private static extern void calib3d_StereoBM_getROI2_10 (IntPtr nativeObj, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 4)] double[] vals);
