...
//javadoc: ANN_MLP
		public class ANN_MLP : StatModel
		{
			...
			return;
				...
				public ANN_MLP (IntPtr addr) : base(addr)
				{
				}
...
return null;
		...
		private static extern void ml_ANN_1MLP_delete (IntPtr nativeObj);
				...
				// C++:  TermCriteria getTermCriteria()
				[DllImport("opencvforunity")]
				private static extern void ml_ANN_1MLP_getTermCriteria_10 (IntPtr nativeObj, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 3)] double[] vals);
